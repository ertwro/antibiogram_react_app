...
const syndromeFilePaths = {
  ...
  'head_and_neck_mastoiditis_mastoiditis_acute': {
    id: 'head_and_neck_mastoiditis_mastoiditis_acute',
    filePath: './syndromes_json/head_and_neck/mastoiditis/mastoiditis_acute.json',
    category: 'head_and_neck',
    subcategory: 'mastoiditis',
    filename: 'mastoiditis_acute',
    title: 'Mastoiditis, Acute',
    loaded: false,
    data: null
  },
  ...
  'infectious_syndromes_fever_in_returning_travelers': {
    id: 'infectious_syndromes_fever_in_returning_travelers',
    filePath: './syndromes_json/infectious_syndromes/fever_in_returning_travelers.json',
    category: 'infectious_syndromes',
    subcategory: null,
    filename: 'fever_in_returning_travelers',
    title: 'Fever in Returning Travelers',
    loaded: false,
    data: null
  },
